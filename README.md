...
Note: Currently, this dashboard only shows the data from your realtime_flights table (the fake data generated by producer.py). It does not yet show the historical data (history_flights) table.
